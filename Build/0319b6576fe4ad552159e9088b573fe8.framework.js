...
var ASM_CONSTS = {
  3250684: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3250739: ($0) => { performance.now = function() { return $0; }; },  
 3250787: ($0) => { performance.now = function() { return $0; }; },  
 3250835: () => { performance.now = Module['emscripten_get_now_backup']; }
};
