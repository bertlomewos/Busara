...
var ASM_CONSTS = {
  3250668: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3250723: ($0) => { performance.now = function() { return $0; }; },  
 3250771: ($0) => { performance.now = function() { return $0; }; },  
 3250819: () => { performance.now = Module['emscripten_get_now_backup']; }
};
