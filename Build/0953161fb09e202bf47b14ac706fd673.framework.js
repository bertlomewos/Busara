...
var ASM_CONSTS = {
  3252252: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3252307: ($0) => { performance.now = function() { return $0; }; },  
 3252355: ($0) => { performance.now = function() { return $0; }; },  
 3252403: () => { performance.now = Module['emscripten_get_now_backup']; }
};
