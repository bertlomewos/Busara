...
var ASM_CONSTS = {
  3250780: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3250835: ($0) => { performance.now = function() { return $0; }; },  
 3250883: ($0) => { performance.now = function() { return $0; }; },  
 3250931: () => { performance.now = Module['emscripten_get_now_backup']; }
};
