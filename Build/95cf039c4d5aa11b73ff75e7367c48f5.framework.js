...
var ASM_CONSTS = {
  3250572: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3250627: ($0) => { performance.now = function() { return $0; }; },  
 3250675: ($0) => { performance.now = function() { return $0; }; },  
 3250723: () => { performance.now = Module['emscripten_get_now_backup']; }
};
