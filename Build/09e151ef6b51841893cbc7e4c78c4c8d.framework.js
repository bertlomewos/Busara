...
var ASM_CONSTS = {
  3252316: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3252371: ($0) => { performance.now = function() { return $0; }; },  
 3252419: ($0) => { performance.now = function() { return $0; }; },  
 3252467: () => { performance.now = Module['emscripten_get_now_backup']; }
};
