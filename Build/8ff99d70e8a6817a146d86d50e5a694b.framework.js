...
var ASM_CONSTS = {
  3251820: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3251875: ($0) => { performance.now = function() { return $0; }; },  
 3251923: ($0) => { performance.now = function() { return $0; }; },  
 3251971: () => { performance.now = Module['emscripten_get_now_backup']; }
};
