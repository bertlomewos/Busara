...
var ASM_CONSTS = {
  3252140: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3252195: ($0) => { performance.now = function() { return $0; }; },  
 3252243: ($0) => { performance.now = function() { return $0; }; },  
 3252291: () => { performance.now = Module['emscripten_get_now_backup']; }
};
