...
var ASM_CONSTS = {
  3252412: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3252467: ($0) => { performance.now = function() { return $0; }; },  
 3252515: ($0) => { performance.now = function() { return $0; }; },  
 3252563: () => { performance.now = Module['emscripten_get_now_backup']; }
};
