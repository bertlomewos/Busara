...
var ASM_CONSTS = {
  3259724: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3259779: ($0) => { performance.now = function() { return $0; }; },  
 3259827: ($0) => { performance.now = function() { return $0; }; },  
 3259875: () => { performance.now = Module['emscripten_get_now_backup']; }
};
