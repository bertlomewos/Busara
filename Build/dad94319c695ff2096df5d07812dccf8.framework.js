...
var ASM_CONSTS = {
  3252428: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3252483: ($0) => { performance.now = function() { return $0; }; },  
 3252531: ($0) => { performance.now = function() { return $0; }; },  
 3252579: () => { performance.now = Module['emscripten_get_now_backup']; }
};
