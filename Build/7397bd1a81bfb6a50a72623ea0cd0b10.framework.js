...
var ASM_CONSTS = {
  3267660: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3267715: ($0) => { performance.now = function() { return $0; }; },  
 3267763: ($0) => { performance.now = function() { return $0; }; },  
 3267811: () => { performance.now = Module['emscripten_get_now_backup']; }
};
