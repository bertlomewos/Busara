...
var ASM_CONSTS = {
  3251596: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 3251651: ($0) => { performance.now = function() { return $0; }; },  
 3251699: ($0) => { performance.now = function() { return $0; }; },  
 3251747: () => { performance.now = Module['emscripten_get_now_backup']; }
};
